...
class lightcurve(object):
    ...
    def plate_solve(self, filt):
        ...
        for i in range(len(science_images)):
            ...
            subprocess.call('/home/iholst/solve_field.sh %s %s %s %s %s' % ((os.path.basename(science_images[i])).removesuffix('.fit'), str(science.header['RA']), str(science.header['DEC']), str(science_images[i]), self.input_path + '/Reduced/Extra'), shell=True)
